...
const CATEGORIES = [
  {
    headline: 'Upgrade Your Audio Experience',
    subheading: 'Premium headphones and earbuds for every moment.',
    buttonText: 'Shop Audio',
    href: '/shop?category=Headphones',
  },
  {
    headline: "The Phone You've Been Waiting For",
    subheading: 'Premium smartphones with the best cameras, battery, and performance—find yours today.',
    buttonText: 'Shop Mobiles',
    href: '/shop?category=Mobiles',
  },
  {
    headline: 'Power Your Day with Laptops',
    subheading: 'Performance and portability for productivity and entertainment.',
    buttonText: 'Shop Laptops',
    href: '/shop?category=Laptops',
  },
  {
    headline: 'Smart Watches, Smarter You',
    subheading: 'Track fitness, stay connected, and style your wrist.',
