...
const isPublicRoute = createRouteMatcher([
  ...
  '/api/store/data(.*)', // Public store profile data (shop page)
  '/api/home-banners(.*)', // Public banners
  '/api/hero-slides(.*)', // Public hero slides
  '/api/footer-config(.*)', // Public footer config (read-only, no auth required)
  '/product(.*)', // Public product detail pages
  '/api/product(.*)', // Public product API (auth-aware inside route for admin checks)
  '/stores(.*)', // Public stores listing page
  ...
  '/find-product(.*)', // Public visual search feature
  '/api/assistant/describe-image(.*)', // Public visual search AI call
]);
